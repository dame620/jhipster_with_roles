...
describe('Component Tests', () => {
  describe('Adviser Management Component', () => {
    let comp: AdviserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdviserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.advisers[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
